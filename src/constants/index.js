...
const certificates = [
  {
    ...
    image: backend_node,
    source_code_link:
      "https://drive.google.com/file/d/1Hzee1FRMpafKBFiY18t-iN3t4DI4ag5X/view?usp=sharing",
  },
  {
    ...
    image: dsa,
    source_code_link:
      "https://drive.google.com/file/d/14XKG0l_LJ0oQ9OsSc71a_20eq7zTgL3-/view",
  },
  {
...
const programmin_platform = [
  {
    name: "LEETCODE",
    description: [
      "🧠 Solved 450+ problems across all difficulty levels",
      "🏆 Maintained a 365-day streak",
  ...
  },
  {
    ...
    description: [
      "✅ Solved 550+ problems covering core Data Structures & Algorithms",
      "🏅 College Rank: 13 — ranked among the top performers",
      "💯 Coding Score: 1582",
      "🔥 175-day streak",
    ],
    image: gfg,
  ...
  },
  {
    name: "HACKERRANK",
    description: [
      "📘 Used to improve programming language skills",
      "💻 Practiced SQL, C++, C#, and JavaScript",
      "✅ Solved many coding problems to strengthen concepts",
